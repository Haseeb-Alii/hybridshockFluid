...
namespace solvers
{
    defineTypeNameAndDebug(hybridshockFluid, 0);
    addToRunTimeSelectionTable(solver, hybridshockFluid, fvMesh);
}
}
...
void Foam::solvers::hybridshockFluid::correctCoNum(const surfaceScalarField& amaxSf)
{
...
void Foam::solvers::hybridshockFluid::clearTemporaryFields()
{
    rho_pos.clear();
    rho_neg.clear();
...
Foam::solvers::hybridshockFluid::~hybridshockFluid()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::solvers::hybridshockFluid::preSolve()
{
    // Read the controls
    readControls();
...
void Foam::solvers::hybridshockFluid::postCorrector()
{
...
void Foam::solvers::hybridshockFluid::postSolve()
{}
